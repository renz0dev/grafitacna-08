...
import { SiLenovo, SiHp } from 'react-icons/si';

const DellLogo = () => (
  <img
    src="https://www.pngall.com/wp-content/uploads/13/Dell-Logo.png"
    alt="Dell Logo"
    className="w-6 h-6"
  />
);
...
function Laptops() {
  ...
  const brandIcons = {
    'HP': <SiHp className="w-6 h-6" />,
    'Dell': <DellLogo />,
    'Lenovo': <SiLenovo className="w-6 h-6" />
  };
