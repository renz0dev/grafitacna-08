...
const Header = memo(() => (
  <header className="w-full">
    ...
    <div className="bg-yellow-400 py-2">
      <div className="container mx-auto px-4 flex justify-between items-center">
        <div className="hidden lg:flex lg:space-x-4 lg:items-center">
          <span className="text-black font-[Itim] text-xl">¡Visita nuestras redes sociales!</span>
          <a
        ...
        <div className="flex items-center text-black space-x-1 font-[Itim] w-full lg:w-auto justify-center lg:justify-end">
          <FaClock size={20} />
    ...
    <div className="bg-[#f6f6f6] py-4 shadow-md sticky top-0 z-50">
      <div className="container mx-auto px-4 flex justify-between items-center">
        <NavLink to="/" className="w-full lg:w-auto flex justify-center lg:justify-start">
          <img src="/grafitacna-logo.png" alt="Logo GrafiTacna" className="h-[81px] w-[106px]" loading="lazy" />
        </NavLink>
        <p className="hidden lg:block text-center text-3xl text-black animate-bounce font-[Itim]">
          ¡Bienvenidos a GrafiTacna! Encuentra lo mejor en tecnología
        </p>
        <div className="hidden lg:flex items-center space-x-2 font-itim">
